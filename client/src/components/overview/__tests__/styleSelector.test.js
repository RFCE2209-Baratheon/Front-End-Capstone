...
describe('It renders the Style Selector component', () => {
  render(<StyleSelector styleData={styleData} currentStyle={currentStyle} onStyleClick={onStyleClick}/>);
  it("Should render the current style", () => {
      const test = screen.getByTestId('style');
